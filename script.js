...
button.addEventListener("click",covid);
var rediv=document.createElement("div");
rediv.setAttribute("id","timer");

div.append(input,linebreak,button,rediv);
...
async function covid() {
  ...
  var active = res2[index].Active ;
  var confirmed = res2[index].Confirmed;
  var death =res2[index].Deaths;
  console.log(death);
